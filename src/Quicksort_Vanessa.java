...
public class Quicksort_Vanessa {
    ...
    public Quicksort_Vanessa(ArrayList<Integer> a, int pivot, int wertLow, int wertHigh)
    {
    ...
    static void partitionMitte(ArrayList<Integer> a) {
        ...
        int indexHigh = a.indexOf(wertHigh);

        for(int x = 0; x<a.size()-1; x++)
        {
            if(a.get(indexLow) > wertHigh)
            {
                indexLow++;
                indexHigh--;
            }
