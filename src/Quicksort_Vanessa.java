...
public class Quicksort_Vanessa extends ProfiledClass {
    ...
    ArrayList<Integer> checks; // liste aus der run methode
    ...
    public void run() {
        ...
        //woher kommen die zahlen 5000 und 600.000?
        // alle seltsamen zahlen einzeln hinzufügen
        checks.add(0);
        checks.add(5000);
        checks.add(600000);
        checks.add(this.field.size() -1);
        ArrayList<Integer> var2 = checks; //dasselbe array unter einem anderen namen kopiert
        int var3 = checks.size(); //varibale die die Länge des array speichert

        for(int var4 = 0; var4 < var3; ++var4) {
            int check = var2.get(var4);
